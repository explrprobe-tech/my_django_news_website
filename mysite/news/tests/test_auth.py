...
class AuthTest(TestCase):
    ...
    def test_category_creation_permission(self):
        ...
        editor_userresponse = self.client.get(reverse('add_category'))
        self.assertEqual(editor_userresponse.status_code, 200, 'Editor user should have access to add category')
